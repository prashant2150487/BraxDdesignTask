...
const Sidebar = () => {
    ...
    return (
        <div>
            ...
            {isOpenColor && (
                <div className="fixed border right-0 top-0 w-full md:w-1/2 z-20 h-full bg-slate-500 text-black p-4">
            ...
            {isOpenLogo && (
                <div className="fixed border z-20 right-0 top-0 w-full md:w-1/2 h-full bg-slate-500 text-black p-4">
