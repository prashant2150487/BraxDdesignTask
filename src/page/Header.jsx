    ...
    return (
        <div>
            ...
            <div className='container max-w-xl'>
                <h1 className='text-6xl font-bold'>Slect a color That matches your brand.</h1>
                <p className='mt-4'>Our team created this tool to help users test color designs for their new website. Simply click the color picker button on the right to try it out.</p>
                <button className='px-3 py-2 border mt-3 rounded-lg text-white' style={{ backgroundColor: color }}>Call to action 2</button>
            </div>
